    ...
    <!-- Navigation -->
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" align="center"><font color="#800080">ONLINE STUDENT FEEDBACK SYSTEM</font> </h1>
...
Here we have developed a online student feedback system, which is used only in the Nituk to rate the faculty based on the performance using nituk domain email id...Here we have 2 modules such as administrator, student.
...
We can start the development from the login page, where we have given the option to login as admin and student...Here since we have only one admin account, so no need to create the a database to store admin info...so the admin username is "Ravindra" and password is "******"...Only Devoloper of this software i.e; Ravindra Singh can login using admin account

He can perform all admin actions such as login to the account and check result..
