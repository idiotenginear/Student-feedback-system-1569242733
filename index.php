...
Here we have developed the a Online Student Feedback system, which will have used only in the NITUK to rate the faculty based on the performance...Here we have 2 modules such as administrator, student.
...
Before we can look into the php code, you need to create a database called "feed" with two tables in it..one as student and another one as take
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#66CCFF">
		<span style="color:#FFFFFF">Developed By ....... 	<a href="https://nituk.ac.in/">Ravindra,Armaan,Sandeep,Venu</a> </span>
	</div>
    <!-- jQuery -->
