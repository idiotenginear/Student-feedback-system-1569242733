...
$err="<font color='purple'>Admin Will Contact you soon</font>";	
...
?>
       ...
       <div class="row">
            <div class="col-md-8">
                <h3><font color="#800080">Contact us </font></h3>
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    Hostel 05 Gvt. Polytechnic NITUK <br>Srinagar Garhwal Uttarakhand, India 246174<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: +917252939462</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="mailto:bt19cse019@nituk.ac.in">bt19cse019@nituk.ac.in</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">H</abbr>: Monday - Sunday: 8:00 AM to 8:00 PM</p>
